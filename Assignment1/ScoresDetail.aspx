    ...
    <div class="container">
        <div class="row">
            <div class="col-md-offset-2 col-md-8">
                ...
                <a href="AddGame.aspx" class="btn btn-success btn-sm">Add Game</a>
                <asp:GridView runat="server" ID="GameTrackingGridView" CssClass="table table-bordered table-striped table-hover" AutoGenerateColumns="false">
                    <Columns>
                        ...
                        <asp:HyperLinkField HeaderText="Edit" Text="Edit" ControlStyle-CssClass="btn btn-primary btn-sm" runat="server" />
                        <asp:CommandField HeaderText="Delete" DeleteText="<i class="fa fa-trash" aria-hidden="true"></i> Delete" ShowDeleteButton="true" ButtonType="Link" ControlStyle-CssClass="btn btn-danger btn-sm" />
                    </Columns>
                </asp:GridView>
            </div>
        </div>
